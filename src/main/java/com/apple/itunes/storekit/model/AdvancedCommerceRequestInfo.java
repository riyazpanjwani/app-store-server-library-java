...
public class AdvancedCommerceRequestInfo {
    ...
    public AdvancedCommerceRequestInfo() {}

    public AdvancedCommerceRequestInfo(UUID requestReferenceId) {
        this.requestReferenceId = AdvancedCommerceValidationUtils.validUUID(requestReferenceId);
    }
     ...
     * @see <a href="https://developer.apple.com/documentation/advancedcommerceapi/advancedCommerceConsistencyToken">advancedCommerceConsistencyToken</a>
     **/
